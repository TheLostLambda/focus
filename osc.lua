...
function decode_message(data)
	...
	for _,t in base.ipairs(types) do
	    ...
	    --pl.dump(message)
	    --pl.dump(t)
		base.io.stderr:flush()
		base.io.stdout:flush()
...
function decode_bundle(data) 
	...
	_, sec, frac = upack(string.sub(tmp_data, 1, 8), ">I>I")
...
function encode_timetag(tpoint)
	if tpoint == 0 then
		...
		return pack(">I>I", sec + ADJUSTMENT_FACTOR, encode_frac(frac))
	end
end
